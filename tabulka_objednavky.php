  ...
  <section class="page-heading">
    <div class="container">
      <div class="row">
        ...
        <h2 style="text-align: center;">Tabuľka objednávok</h2>
        ...
        <?php
         ...
         $query = "Select * FROM kapko_objednavka GROUP BY id_objednavky ORDER BY id_objednavky";
         ...
         if (mysqli_num_rows($query_run) > 0)
         {
             ...
             <tr>
                 <td><?= $row['id_objednavky']; ?></td>
                 <td><?= $row['id_partnera']; ?></td>
                 <td><?= $row['datum_obj']; ?></td>
                 <td><?= $row['datum_dod']; ?></td>
                 <td><?= $row['cena_obj']; ?></td>
             </tr>
