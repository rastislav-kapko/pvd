...
<section>
<img src="tab4.png" alt="Tu bude obrazok grafu rok">
</section>
    ...
    <div class="container">
      <div class="row">
        ...
        <?php
         ...
         $query = "SELECT ifnull(t.rok,'spolu')Rok , sum(IF(t.id_vuc='BA',t.polozka,0)) as 'BA' , sum(IF(t.id_vuc='TT',t.polozka,0)) as 'TT' , sum(IF(t.id_vuc='NI',t.polozka,0)) as 'NI' ,sum(t.polozka) as 'spolu' FROM kapko_tf2 t group by t.rok";
...
?>
  ...
  <section>
<img src="tab5.png" alt="Tu bude obrazok grafu mesiac">
</section>
    ...
    <div class="container">
      <div class="row">
        ...
        <?php
         ...
         sum(t.polozka) as 'spolu' FROM kapko_tf2 t group by t.id_s WITH ROLLUP";
...
?>
  ...
  <section>
<img src="tab6.png" alt="Tu bude obrazok grafu den">
</section>
