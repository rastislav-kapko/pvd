            ...
            <div class="col-md-12">
                <div class="card mt-4">
                    <div class="card-header">
                        <h4>Filtrovanie Dodacích listov</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="" method="GET">
                            <div class="row">
                                <div class="col-md-4">
                                    <label for="">Dodacie listy od</label>
                                ...
                                <div class="col-md-4">
                                    <label for="">Dodacie listy do</label>
...
<table class="table table-bordered" style="background-color: white;" style="text-align: center;">
        ...
        <tbody style="text-align: center;">
                        ...
                        if(isset($_GET['start_price']) && isset($_GET['end_price']))
                        {
                            ...
                            $query = "SELECT * FROM kapko_dodaci_list WHERE datum_obj BETWEEN '$startprice' AND '$endprice' ";
                        }
                        else
                        {
                            $query = "SELECT * FROM kapko_dodaci_list";
                        }
