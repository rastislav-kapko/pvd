...
<section>
<img src="tab1.png" alt="Tu bude obrazok grafu rok">
</section>
  ...
  <section class="page-heading">
    <div class="container">
      <div class="row">
        ...
        <h2 style="text-align: center;">Tabuľka nákladov podľa času(rok)</h2>
...
?>
  ...
  <section>
<img src="tab2.png" alt="Tu bude obrazok grafu mesiac">
</section>
    ...
    <div class="container">
      <div class="row">
        ...
        <?php
         ...
         $query = "SELECT (t.mesiac), SUM(t.polozka) FROM kapko_tf2 t where rok = 2017 GROUP BY t.mesiac ORDER BY t.mesiac";
...
?>
  ...
  <section>
<img src="tab3.png" alt="Tu bude obrazok grafu den">
</section>
  ...
  <section class="page-heading">
    <div class="container">
      <div class="row">
        ...
        <h2 style="text-align: center;">Tabuľka náklady podľa času - dni v novembri v roku 2019</h2>
        <tbody style="text-align: center;">
        ...
        <?php
         ...
         $query = "SELECT (t.den ), SUM(t.polozka) FROM kapko_tf2 t where mesiac = 11 AND rok = 2019 GROUP BY t.den ORDER BY t.den";
