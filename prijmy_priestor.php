...
<section>
<img src="tab21.png" alt="Tu bude obrazok grafu rok">
</section>
    ...
    <div class="container">
      <div class="row">
        ...
        <?php
         ...
         $query = "SELECT (t.`id_vuc` ), SUM(t.polozka) FROM kapko_tf3 t GROUP BY t.`id_vuc` ORDER BY t.`id_vuc`";
...
?>
  ...
  <section>
<img src="tab22.png" alt="Tu bude obrazok grafu mesiac">
</section>
    ...
    <div class="container">
      <div class="row">
        ...
        <?php
         ...
         $query = "SELECT (t.`id_okr` ), SUM(t.polozka) FROM kapko_tf3 t GROUP BY t.`id_okr` ORDER BY t.`id_okr`";
